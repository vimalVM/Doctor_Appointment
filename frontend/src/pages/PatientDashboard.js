...
export default function PatientDashboard() {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const res = await axiosInstance.get(`/search-doctors?q=${searchTerm}`);
    ...
    <>
      ...
      <nav className="navbar bg-body-tertiary bg-primary fixed-top">
        <div className="container-fluid">
          <a className="navbar-brand" href="#"><strong>ClinicHub</strong></a>
            ...
            <div className="offcanvas-body">
              <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li className="nav-item">
                  <a className={`nav-link ${ currentView === "home" ? "active" : "" }`} aria-current="page" href="#" onClick={() => handleViewChange("home")}>
                    Home
                  </a>
                </li>
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu">
                    <li>
                      <a className="dropdown-item" href="#" onClick={() => handleViewChange("upcoming")}>Upcoming</a>
                    </li>
                    <li>
                      <hr className="dropdown-divider" />
                    </li>
                    <li>
                      <a className="dropdown-item" href="#" onClick={() => handleViewChange("book")}>
                        Book
                      </a>
                    </li>
                  </ul>
                ...
                <li className="nav-item">
                  <a className="nav-link text-danger" href="#" onClick={goToLogin}> Logout</a>
                </li>
              </ul>
